...
/**
 * API Client for interacting with the /transacoes endpoints.
 * Its responsibility is to make HTTP calls and return the full response.
 */
public class TransactionsClient {
    ...
    // Dentro da classe TransactionsClient.java
    ...
    public Response createTransactionWithEmptyBody() {
        return given()
                // É uma boa prática enviar o header Content-Type mesmo com o corpo vazio
                .contentType(ContentType.JSON)
                .when()
                .post("/transacoes");
    }
