...
/**
 * Esta classe contém métodos para configurar pré-condições e dados comuns para os testes.
 * Ela ajuda a manter a etapa "Arrange" dos testes limpa e legível.
 */
public class TestDataSetup {

    // Instâncias estáticas dos clients que serão usados pelos métodos de setup.
